...
WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/span_View Access History'))

WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/div_TimestampActionIP AddressSession IDDec _498c24'))
