...
WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/div_Profile PictureClick to upload an image'))

WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/button_Select'))

WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/button_Save'))

WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/button_'))
