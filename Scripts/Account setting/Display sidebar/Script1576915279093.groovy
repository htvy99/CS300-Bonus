...
WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/button_Sidebar'))

WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/div_Channel SwitcherEditOn'))

WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/input_On_channelSwitcher'))
...
WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/div_Main Menu'))
