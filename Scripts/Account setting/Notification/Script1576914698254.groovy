...
WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/button_Notifications'))

WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/span_Edit'))

WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/input_Send desktop notifications_desktopNot_5d291d'))
