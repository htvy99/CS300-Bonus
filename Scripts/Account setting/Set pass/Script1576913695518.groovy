...
WebUI.click(findTestObject('Page_Mattermost/input_All team communication in one place s_703ef5'))
...
WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/button_Security'))

WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/div_PasswordEditLast updated Dec 21 2019 at 234 PM'))

WebUI.setEncryptedText(findTestObject('Page_Town Square - 300 Bonus Mattermost/input_Current Password_currentPassword'), 
    '64O22nEDKRkueMYucGcRBg==')

WebUI.setEncryptedText(findTestObject('Page_Town Square - 300 Bonus Mattermost/input_New Password_newPassword'), 'oZ32Lzew/7k=')

WebUI.setEncryptedText(findTestObject('Page_Town Square - 300 Bonus Mattermost/input_Retype New Password_confirmPassword'), 
    'oZ32Lzew/7k=')
