...
WebUI.setText(findTestObject('Object Repository/Msg-1/textarea_hah'), 'haha')

WebUI.click(findTestObject('Object Repository/Msg-1/button_haha_style--none emoji-picker__conta_978991'))

WebUI.click(findTestObject('Object Repository/Msg-1/img_People_emoji-1f602'))

WebUI.click(findTestObject('Object Repository/Msg-1/a_haha joy_send-button theme'))
