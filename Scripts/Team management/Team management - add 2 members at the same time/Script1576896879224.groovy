...
WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/div_truc01633gmailcom_more-modal__actions--round'))

WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/div_truc01633gmailcom_more-modal__actions--round'))

WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/span_Add'))
