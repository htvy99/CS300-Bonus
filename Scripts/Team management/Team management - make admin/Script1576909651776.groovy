...
WebUI.click(findTestObject('Object Repository/Page_Town Square - 300 Bonus Mattermost/span'))

WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/button_Manage Members'))

WebUI.click(findTestObject('Page_Town Square - 300 Bonus Mattermost/span_Member'))

WebUI.click(findTestObject('Object Repository/Page_Town Square - 300 Bonus Mattermost/button_Make Team Admin'))
